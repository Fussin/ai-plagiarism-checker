...
export default function RegisterPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (success) {
      ...
      // Error message might be too generic here, as signup function in AuthContext
      // logs specific error but returns general false. Consider improving error propagation.
      setError('Signup failed. The email might already be registered or an error occurred.');
    }
    setIsSubmitting(false);
  };

  // If user is already logged in and tries to access /register, redirect them
  useEffect(() => {
