...
import { useEffect } from 'react'; // Already have this at the bottom, ensure it's at top
...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (!authIsLoading && user) {
      router.replace('/'); // or '/dashboard' or preferred page
    }
  }, [user, authIsLoading, router]);

  if (authIsLoading || (!authIsLoading && user)) {
    // Show loading state or null if user already logged in (will be redirected)
...
// Removed redundant useEffect import from here
